...
Use `Az-Framework/modules/insurance` through the main `Az-Framework` resource instead of installing this repository as a separate FiveM resource.

## Migration

1. Remove `ensure Az-Insurance` from `server.cfg`.
